...
const AboutUs = () => {
  ...
  return (
    ...
    >
      <div className="md:w-full flex flex-col items-start md:pt-10">
        <h2 className="text-start">{t("about-title")}</h2>
        <p className="pt-5 md:w-10/12">{t("about-text")}</p>
      ...
      <div className="flex flex-col items-end w-full pt-8 md:pt-0 items-center md:items-end ">
        <img
