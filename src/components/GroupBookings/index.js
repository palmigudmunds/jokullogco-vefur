...
const custom = 'https://res.cloudinary.com/dq2uenf18/image/upload/q_auto,f_auto,fl_lossy/v1684669939/jokullogco/sections/50D4819A-750E-4DD6-9734-A54199DAA7EA_1_201_a-min_u988ae.jpg';
...
const GroupBookings = () => {
    ...
    return (
        <div data-aos="fade-up" id="hopabokanir" className="flex flex-col-reverse md:flex-row justify-center max-w-none">
