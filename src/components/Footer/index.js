...
import logo from "../../resources/logos/logo-white.png";
    ...
    <footer className="p-4 bg-maindarkblue md:p-8 lg:p-10">
      <div className="mx-auto max-w-screen-xl text-center">
        ...
        <ul className="flex flex-col justify-center items-center space-y-1 list-none list-inside text-white font-light text-sm">
          <li>
            <a
              href="https://goo.gl/maps/neM2qegvaRXAcGQx9"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm hover:text-maingold"
            >
          ...
          <li>
            <a
              href="mailto:jokull@jokullogco.com"
              className="text-sm hover:text-maingold"
            >
              jokull@jokullogco.com
            </a>
          </li>
        </ul>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a
              href="https://www.facebook.com/jokullogco"
              target="_blank"
              rel="noopener noreferrer"
              class="text-white hover:text-maingold"
            >
              <svg
                class="w-5 h-5"
                fill="currentColor"
